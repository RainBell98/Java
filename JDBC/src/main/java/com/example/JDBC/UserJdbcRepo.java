...
//        //queryForObject : 주어진 쿼리에 따라 데이터 베이스에서 한 행만 반환되길 기대할 때 사용
//        //Users클래스의 인스턴스로 매핑하기 위해서 new BeanPropertyRowMapper<>(Users.class)
//        //new BeanPropertyRowMapper: 데이터 베이스 테이블의 칼럼 이름과 Java Bean의 프로퍼티 이름을 자동으로 매칭
...
//    //queryForInt() : 단일 값 반환. 반환값으로 int 형태 데이터(select count(*) from___)
//}
